...
var initShowcase = function () {
  var showcase = document.querySelector('.js-showcase');
  if (!showcase) return;
  var flickity = new Flickity(showcase, {
  ...
  var showcaseNav = document.querySelector('.js-showcase-nav');
  if (!showcaseNav) return;
  var flickityNav = new Flickity(showcaseNav, {
    cellSelector: '.js-showcase-nav-item',
    asNavFor: '.js-showcase',
    wrapAround: false,
    prevNextButtons: false,
    pageDots: false,
    autoPlay: false,
